...
% HINT 2: You can use the pinv function to invert a transformation.
    ...
    if (currentFrameIndex<refFrameIndex)
            for idx = currentFrameIndex:1:refFrameIndex-1
            T = i_To_iPlusOne_Transform{idx}*T; 
            end
        
    elseif (currentFrameIndex>refFrameIndex)      
            for idx = currentFrameIndex-1:-1:refFrameIndex
            T = pinv(i_To_iPlusOne_Transform{idx})*T; 
            end         
    end
